...
export function credentialRequestDetector(context: DetectorContext): DetectorResult {
  ...
  const hasActiveRequest = activeRequestPattern.test(lower) || reverseActivePattern.test(lower)
